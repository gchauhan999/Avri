...
import { forbidden, unauthorized } from "../helpers/http-error.js";
import { AdminUser } from "../models/index.js";
import type { AdminRole } from "../models/admin_users.js";
...
export const requireAuth: RequestHandler = async (req, res, next) => {
  try {
     ...
     */
    const user = await AdminUser.findByPk(Number(payload.sub));
